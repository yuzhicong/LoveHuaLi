 ...
 */
public class StudentScoreAnimatedListViewAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
    private Context context;
    private List<JSONObject> jsonObjectList;

    public StudentScoreAnimatedListViewAdapter(Context context,List<JSONObject> jsonObjectList){
    ...
    public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            tvGpa.setText("课程绩点：" + ClassInfo.getString("gpa"));
